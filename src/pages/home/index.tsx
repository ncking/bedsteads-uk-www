...
import { Container, Row, Column, Columns } from '@raiz/react'
...
export default () => {
  return (
    <>
      ...
      >
        <Container ><div className={cx(styles.title, 'logotype')}>Bedsteads</div></Container>
      ...
      <Container >
        ...
        <Row>
          <Columns className="cols-1 md:cols-2 xl:cols-3">
            <Column className={styles.textCol}>
              <p>
