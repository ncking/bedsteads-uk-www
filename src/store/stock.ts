...
const actions = (set) => {
    ...
    function getItemById(id) {
        // used by favs ... might not bethe current item (favs select in tiles view)
...
stockStore.useStoreShallow = (selector) =>
    stockStore.useStore(selector, isEqualShallow)
